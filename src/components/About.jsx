    ...
    <>
      <div className="flex flex-col items-center justify-center w-full h-full bg-stone-300 rounded-t-lg">
        <div className=" w-full leading-relaxed font-titleFont text-3xl">
          <h1 className="flex justify-center xl:justify-start xl:pl-40 p-5 text-5xl md:text-5xl underline decoration-cyan-500 text-white bg-black font-titleFont rounded-t-lg">
            About
          </h1>
