...
function About({ itemData }) {
  ...
  return (
    <>
      <div className="flex flex-col items-center justify-center mt-10 w-full h-full bg-stone-300 rounded-t-lg">
        <div className=" w-full leading-relaxed font-titleFont text-3xl">
          <h1 className="flex justify-center xl:justify-start xl:pl-48 p-5 text-5xl md:text-7xl underline decoration-green-400 text-white bg-black font-titleFont rounded-t-lg">
            About
          </h1>
