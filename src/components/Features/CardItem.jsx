  ...
  return (
    <>
      {cardInfo.map((infoItems) => (
            <div key={infoItems.id} className="flex flex-col justify-center py-4 px-3 md:px-7 md:py-8 w-full h-full  mt-20 text-white hover:text-yellow-400 rounded">
              ...
              <p className=" pt-5 md:pt-10 font-sans font-bold text-2xl rounded">{infoItems.projectLable}</p>
            </div>
      ))}
    </>
  );
