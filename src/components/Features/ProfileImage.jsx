  ...
  return (
    <div className=" flex flex-col items-center justify-items-center justify-evenly sm:mx-20 text-decoration hover:underline hover:decoration-blue-400 ">
      <img
        src={profilePicture}
        alt="profilePhoto"
        className="flex rounded-full h-40 w-40 sm:h-50 sm:w-50 lg:h-50 lg:w-50 xl:h-80 xl:w-80 transition-all duration-1000 cursor-pointer filter grayscale hover:grayscale-0 drop-shadow-md hover:drop-shadow-2xl transition ease-in-out delay-150 hover:translate-y-1 hover:scale-110 duration-750"
      />
